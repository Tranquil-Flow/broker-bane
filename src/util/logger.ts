...
const PII_PATHS = [
  ...
  "profile.first_name",
  "profile.last_name",
  "broker_identity.email",
  "broker_identity.smtp.auth.pass",
  "broker_identity.inbox.auth.pass",
  "config.email.auth.pass",
  "config.inbox.auth.pass",
  "config.broker_identity.email",
  "config.broker_identity.smtp.auth.pass",
  "config.broker_identity.inbox.auth.pass",
  "auth.pass",
  "auth.user",
  "pass",
];
